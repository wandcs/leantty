...
| 桌面终端界面与交互收敛 | Verified 1.2；Implementing 1.3 Tab 层级修订 | 1.2–1.3 | [`ui-interaction-polish.md`](ui-interaction-polish.md) |
...
| 本地命令提示符与输出规范 | Implementing / 1.3 提示符修订 | 1.3 | [`local-command-output.md`](local-command-output.md) |
