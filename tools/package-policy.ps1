function Assert-LeanTTYReleasePackageExcludesAcceptanceMarkers {
    param(
        ...
        [string[]]$Markers = @(
            ...
            'STARTUP_PERF phase=',
            'STARTUP_WARM phase=',
            'NativeStartupPerformance',
            'NATIVE_OUTPUT_PROBE',
            'ACCEPTANCE_NATIVE_PAGE',
            'ACCEPTANCE_NATIVE_WRITE_CONSUMED',
            'ACCEPTANCE_NATIVE_SEARCH_',
            'acceptancePageFingerprint',
            'acceptancePageSequence_',
            'acceptancePaneId',
            'NATIVE_INPUT_PROBE',
            'NativeOutputProbe',
            'acceptanceConsumed',
            ...
            'rejectSurfaceForAcceptance',
            'loseContextForAcceptance',
            'loseNativeContextForAcceptance',
            'acceptanceContextLoss_',
            'blockGpuForAcceptance',
            'blockNativeGpuForAcceptance',
            'acceptanceGpuBlocked_',
            'acceptance_gpu_initialize_failed',
            'acceptance_gpu_context_loss',
            'ACCEPTANCE_NATIVE_GPU',
            'ACCEPTANCE_NATIVE_VISIBILITY',
